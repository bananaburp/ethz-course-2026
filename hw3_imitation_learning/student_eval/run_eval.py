...
-----
    ...
    python student_eval/run_eval.py --exercise 3 --checkpoint ./checkpoints/multi_cube/best_model_ee_xyz_multitask_dagger18ep_59.pt
    
    python student_eval/run_eval.py --exercise 3 --checkpoint ./checkpoints/multi_cube/best_model_ee_full_multitask.pt
    python student_eval/run_eval.py --exercise 3 --checkpoint ./checkpoints/multi_cube/best_model_ee_full_multitask_dagger18ep.pt
