...
Usage:
    python scripts/dagger_eval_multicube.py \
        --checkpoint ./checkpoints/multi_cube/best_model_ee_full_multitask_dagger6ep.pt \
        --num-episodes 12 \
        --goal-cube all

    # Specific color only:
    python scripts/dagger_eval_multicube.py \
        --checkpoint ./checkpoints/multi_cube/best_model_ee_xyz_multitask_dagger24ep.pt \
        --goal-cube all \
        --num-episodes 15
"""
